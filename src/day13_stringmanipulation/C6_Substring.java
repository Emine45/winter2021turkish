...
public class C6_Substring {
	...
	public static void main(String[] args) {
		...
		System.out.println(str.substring(0, 10));  // substring(0, 10) yazildiginda 0 inclusive, 10 exculisive
		
		//11. ci karakterden sonuna kadar olan Stringi yazdiralim
		System.out.println(str.substring(10));
		
		// str'in ilk 10 harfini * ile gizleyin, geri kalanlar normal yazilsin
		System.out.println("**********" + str.substring(10));
		
		System.out.println(str.substring(0,10).replaceAll("\\D","*")+str.substring(10));
		
		System.out.println(str.substring(10,10));  // baslangic indexi olsun der, sonra bitis indexi olmasin der,
		...
		//str'in ilk 10 karakter * ile gizleyin, geriye kalanlar normal yazilsin
