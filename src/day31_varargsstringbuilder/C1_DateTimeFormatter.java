...
public class C1_DateTimeFormatter {
	...
	public static void main(String[] args) {
		...
		/*
		 * yy : yilin son iki rakamini yyyy: yilin tamamini M: ay sirasini verir mart
		 * icin : 3 MM: ay sirasini verir mart icin : 03 MMM : Ay isminin ilk uc harfini
		 * verir MMMM : Ay isminin tamamini veir
		 */
