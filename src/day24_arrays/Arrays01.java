...
public class Arrays01 {
	...
	public static void main(String[] args) {
		...
		int arr[] = {10,20,30,40};  //int [] arr seklinde de kullanilabilir
		                           // Bu ornekte Array'in elemanlarini direk yazdigim icin
		                           // uzunluk belirtmeye ihtiyac kalmadi.
		                           // Bu kullanimda max eleman sayisi (length) yazdigimizda eleman sayisidir
		
	
		System.out.println(arr);  // Array bir object'dir
		                          // Eger direk olarak Array'i yazdirmak isterseniz Java referans'i yazdirir
		...
		// takim[3] = "Mehmet";  //Java Run Time programdir, dolayisyla array programi calistirinca olusturur.
		                         //38. satirda syntax olarak hata olmadigindan CTE olmaz
