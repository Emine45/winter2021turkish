...
public class C1_IfElseIf {
	...
	public static void main(String[] args) {
		...
		String gunIsmi = scan.nextLine();  // girilen yaziyi kucuk harfe cevirdik
		...
		// equalsIgnoreCase() : methodu iki String'in buyuk, kucuk harf hassiyeti olmadan esit olup olmadigini kontrol eder.
