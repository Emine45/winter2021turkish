...
public class C4_OperatorsSign {
	...
	public static void main(String[] args) {
		...
		boolean isEqual = sayi1==sayi2;   //== esit mi anlamina gelir ve Comperison operator
		...
		System.out.println(sayi1 - sayi2 != 0);   //(5-4=1)==> 1 sifira esit degildir.  true
		
		// tum mantiksal ifadelerde ! kullanildiginda olumsuzlik anlami katar
