...
public class C1_MethodCreation1 {
	...
	public static void main(String[] args) {
		...
		// sadece parametre sayisi degil parametre'lerin tiplerine de bakar
		
		str.endsWith("el");  // Bu methodu'un gorevi gidip kelimenin son kismini kontrol etmek
		...
		//   ve gorevi yaptiktan sonra bana ne dondurecegini bastan karar vermeliyiz
