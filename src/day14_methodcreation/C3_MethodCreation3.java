...
public class C3_MethodCreation3 {
	...
	public static void main(String[] args) {
		...
		ortalama(80, 60, 55);  //1. yi calistirir ve sonuc olarak 65.0 yazdirir
		ortalama(80, 60);      //2. yi calistirir ve sonuc olarak 70.0 yazdirir

	}

	public static void ortalama(double sayi1, double sayi2, double sayi3) {
		System.out.println("Girdiginiz uc sayinin ortalama :" + (sayi1 + sayi2 + sayi3) / 3);
	}
