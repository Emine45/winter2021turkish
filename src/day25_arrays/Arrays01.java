...
public class Arrays01 {
	...
	public static void main(String[] args) {
		// Array (Dizi): Java'da birden fazla variable store etmek icin kullanilan
		// objelerden biridir
		// Array olusturulurken 2 seyi declare etmeliyiz: 1- data type (Bir array'in
		// icerisinde
		// sadece ayni data tipinden elemanlar olabilir.) 2- uzunluk (uzunluk array'in
		// icerisne konulacak m
		...
		// edilebilir
		// Mesela isimler array'inin icinde isim degerleri degil, isimlerin referanslari
		// olur
